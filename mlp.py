...
# convert 1D class arrays to 10D class matrices, dit waarschijnijk aanpassen 
...
model.add(Dense(64, activation='linear', name='hidden_layer_1')) #linear
model.add(Dense(63, activation='linear', name='hidden_layer_2'))
model.add(Dense(63, activation='linear', name='hidden_layer_3'))
# output layer with 10 nodes (one for each class) and softmax nonlinearity
model.add(Dense(40, activation='soft-max'))  #ipv softmax linear
