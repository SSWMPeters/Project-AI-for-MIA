...
# Directory containing images for class 0
...
display_images(class_1_images, ['Class 0: Patch 1', 'Class 0: Patch 2', 'Class 0: Patch 3'])
display_images(class_2_images, ['Class 1: Patch 1', 'Class 1: Patch 2', 'Class 1: Patch 3'])
